...
import {
  Eraser, FileText, Hash, Home, Image, Scissors, SquarePen, Users, LogOut
} from 'lucide-react'
        ...
        <div onClick={openUserProfile} className='flex gap-2 items-center cursor-pointer'>
          ...
          <div>
            ...
            <p className='text-xs text-gray-500'>
              <Protect plan='pixpen_ai_' fallback="Free Member">
                Pixpen.ai<span className='font-semibold'>+</span> Member
              </Protect>
            </p>
          </div>
        </div>
